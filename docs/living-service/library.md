...
馆内还提供自助打印、复印、扫描、电子资源检索、数据库使用、馆际互借和文献传递等服务。自助复印、打印、扫描一体机分布在主馆一楼自助服务区、主馆 B300 阅览室门口、包玉刚图书馆一楼大厅及四楼、五楼、四楼联楼、李政道图书馆二楼服务台、徐汇校区图书阅览空间一楼等位置；扫描通常免费，具体收费和设备状态以[自助复印、打印服务](https://old.lib.sjtu.edu.cn/f/content/detail.shtml?id=6172&lang=zh-cn)页面及现场设备提示为准。需要门市复印、打印或装订时，可前往主馆 C110。

校外使用学校订购的数据库时，应通过学校提供的统一身份认证、VPN 或图书馆公布的校外访问方式进入，不建议从不明网站下载论文。
